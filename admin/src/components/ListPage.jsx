...
{displayed.map((doc) => {
  ...
  const schedule = buildScheduleMap(doc.schedule || {});
  const sortedDates = getSortedScheduleDates(schedule);
    ...
    <div className={doctorListStyles.feesValue}>
      <BadgeIndianRupee /> {doc.fee}
              ...
              <div
                ...
                style={{
                  maxHeight: isOpen ? (isMobileScreen ? "320px" : "600px") : "0px",
                  transition:
