...
export const navbarStyles = {
  ...
  logoTitle: "text-lg font-semibold text-emerald-700 ml-3",
  logoSubtitle: "text-sm text-emerald-500 ml-3",
  
  // Center navigation (desktop)
  centerNavContainer: "hidden lg:flex items-center justify-center relative",
  glowEffect: "relative rounded-3xl p-1 bg-linear-to-r from-emerald-100 via-emerald-200 to-emerald-100 shadow-xl",
