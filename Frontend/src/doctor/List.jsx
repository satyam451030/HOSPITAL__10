...
import { Calendar, Phone, Search, X, RefreshCw, User } from "lucide-react";
...
function AppointmentCard({ appointment, onStatusChange, onReschedule }) {
  ...
  return (
    <div className={listPageStyles.appointmentCard}>
      ...
      <div className={listPageStyles.cardHeader}>
        ...
        <div className={listPageStyles.cardContent}>
          <p className={listPageStyles.cardPatientName}>
            {appointment.patient}
          </p>
          ...
          {appointment.doctorName && (
            <p className={listPageStyles.cardDoctorInfo}>
              Dr.{" "}
      ...
      <div className={listPageStyles.dateTimeSection}>
        ...
        <div className={listPageStyles.feeText}>₹{appointment.fee}</div>
      </div>
      ...
      <div className={listPageStyles.rescheduleContainer}>
        <RescheduleButton
          appointment={appointment}
          onReschedule={(d, t) => onReschedule(appointment.id, d, t)}
        />
      </div>
    </div>
  );
        ...
        <div className={listPageStyles.headerContainer}>
          <div>
            ...
            <p className={listPageStyles.headerSubtitle}>
              {loading
                ? "Loading…"
                : `${filtered.length} of ${appointments.length} appointment${
